...
Route::get('volunteer/:volunteer_user_id/new_request', 'portal/dashboard.patient/newServiceRequest')->pattern(['volunteer_user_id' => '\d+']);
Route::get('volunteers', 'portal/dashboard.patient/listVolunteers');

Route::rule('volunteer/profile', 'portal/dashboard.volunteer/profile', 'GET|POST');
...
Route::get('volunteer/:user_id', 'portal/dashboard.volunteer/publicProfile')->pattern(['user_id' => '\d+']);
